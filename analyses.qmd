...
set.seed(1100101)
fit_h1a <- brm(
  formula = inqiry_habit ~ practical_experience,
  data = df,
  prior = prior(student_t(10, 0, .5), # fairly informative prior for slope
                coef = practical_experience), 
...
hypothesis(fit_h1a, "abs(practical_experience) < .1")
# hypothesis(fit_h1a, "practical_experience = 0")
```


** or is it the teaching profession as practical experience?**
